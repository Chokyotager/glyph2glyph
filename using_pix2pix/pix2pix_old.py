...
class Pix2Pix ():
    ...
    def __init__ (self):
        ...
        lr_discrim = keras.optimizers.schedules.ExponentialDecay(initial_learning_rate=4e-6, decay_steps=10000, decay_rate=0.99)
        lr_gen = keras.optimizers.schedules.ExponentialDecay(initial_learning_rate=2e-5, decay_steps=10000, decay_rate=0.999)

        discrim_optimizer = keras.optimizers.Adam(learning_rate=lr_discrim, beta_1=0.5, beta_2=0.999)
        gen_optimizer = keras.optimizers.Adam(learning_rate=lr_gen, beta_1=0.6, beta_2=0.999)
    ...
    def buildGenerator (self):
        ...
        # Upsampling
        u1 = deconv2d(d7, d6, self.gf*8, dropout_rate=0)
    ...
    def buildDiscriminator (self):
        ...
        d1 = d_layer(combined_imgs, self.df, bn=self.dbn, dropout_rate=0.1)
